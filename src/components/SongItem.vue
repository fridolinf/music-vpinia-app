<template>
  <li
    class="flex justify-between items-center p-3 pl-6 cursor-pointer transition duration-300 example border-gray-400 border-b"
  ...
  >
    <div>
      <router-link
        ...
        class="font-bold block text-black song-item"
